# ArtifactsMmoClient.Api.ResourcesApi
...
namespace Example
{
    public class GetAllResourcesResourcesGetExample
    {
        public static void Main()
        {
            ...
            var skill = new GatheringSkill?(); // GatheringSkill? | Skill of resources. (optional) 
            ...
            {
                Debug.Print("Exception when calling ResourcesApi.GetAllResourcesResourcesGet: " + e.Message);
...
#### Using the GetAllResourcesResourcesGetWithHttpInfo variant
...
{
    Debug.Print("Exception when calling ResourcesApi.GetAllResourcesResourcesGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **skill** | [**GatheringSkill?**](GatheringSkill?.md) | Skill of resources. | [optional]  |
...
|-------------|-------------|------------------|
| **200** | Successfully fetched resources. |  -  |
...
namespace Example
{
    public class GetResourceResourcesCodeGetExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new ResourcesApi(httpClient, config, httpClientHandler);
            var code = "code_example";  // string | The code of the resource.
            ...
            {
                Debug.Print("Exception when calling ResourcesApi.GetResourceResourcesCodeGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the GetResourceResourcesCodeGetWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get Resource
    ApiResponse<ResourceResponseSchema> response = apiInstance.GetResourceResourcesCodeGetWithHttpInfo(code);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ResourcesApi.GetResourceResourcesCodeGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
